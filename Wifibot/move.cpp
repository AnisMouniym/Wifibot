    ...
    : QWidget{parent}
{
    //. Taille fenetre
        ...
        setButton(_Up, QRect(61,0,41,41), ": /Move/icones/up.png");

        _Left = new QPushButton(this);
        setButton(_Left, QRect(20,41,41,41), ": /Move/icones/left.png");

        _Right = new QPushButton(this);
        setButton(_Right, QRect(102,41,41,41), ": /Move/icones/right.png");

        _Down = new QPushButton(this);
        setButton(_Down, QRect(61,82,41,41), ": /Move/icones/down.png");
        ...
        connect(_Up, SIGNAL(pressed()), this, SLOT(sMoveUp()));
        connect(_Left, SIGNAL(pressed()), this, SLOT(sMoveLeft()));
        connect(_Right, SIGNAL(pressed()), this, SLOT(sMoveRight()));
        connect(_Down, SIGNAL(pressed()), this, SLOT(sMoveDown()));
        connect(_Stop, SIGNAL(pressed()), this, SLOT(sMoveStop()));
